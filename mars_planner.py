...
class RoverState:
    def __init__(self, loc="station", sample_extracted=False, holding_sample=False, charged=False,
                 sample_at_station=False, x=0, y=0, holding_tool=False):
        self.loc = loc
        ...
        self.x = x
        self.y = y
        self.sample_at_station = sample_at_station
        self.prev = None
    ...
    def __eq__(self, other):
        return (self.loc == other.loc and
                ...
                self.sample_at_station == other.sample_at_station and
...
def charge(state):
    ...
    r2.prev = state
    return r2
# use_tool should return a new state with the sample_extracted variable set to True.
def use_tool(state):
    r2 = deepcopy(state)
